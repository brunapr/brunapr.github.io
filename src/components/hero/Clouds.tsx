export function Clouds() {
  const commonStyle = "moving-object absolute opacity-20"

  const clouds = [
    {
      src: "/assets/cloud_3.svg",
      move: "-10",
      className: `${commonStyle} left-0 top-10 scale-80 lg:scale-80 lg:left-0 lg:top-10`,
      alt: "top left cloud"
    },
    {
    ...
    },
    {
      ...
      move: "15",
      className: `${commonStyle} right-[-4rem] bottom-46 scale-80 lg:scale-80`,
