...
export default function DesktopTab({
  ...
  return (
    <div
      id="tab_home"
      className={`max-w-[480px] max-md:h-fit md:max-h-[350px] h-full w-full z-[2] top-1/2 md:top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:-translate-y-1/3 absolute md:bg-violet-100 dark:md:bg-slate-700 flex flex-col rounded-lg border-3 border-[#00000000] md:border-slate-800 select-none`}
    >
