...
export default function DesktopTab({
  ...
  return (
    <div className="max-w-5xl w-full flex justify-center items-center h-[calc(var(--dvh)-36px)] md:h-[calc(var(--dvh)-7rem)] transition-[height]">
      <div
        id="tab_home"
        className={`max-w-[480px] z-[2] max-h-[415px] md:max-h-[350px] h-full w-full md:bg-violet-100 dark:md:bg-slate-700 flex flex-col rounded-lg border-3 border-[#00000000] md:border-slate-800 select-none`}
      >
