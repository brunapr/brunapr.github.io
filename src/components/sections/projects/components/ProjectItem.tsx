      ...
      <div className="flex flex-col justify-between min-h-32">
        <div className="flex flex-col w-full">
          <div className="flex space-x-2 items-center">
            <h1 className="text-lg font-mono text-violet-400 dark:text-indigo-400">{title}</h1>
            <span className="text-slate-400 dark:text-slate-500 text-xs font-abz ">[{tags}]</span>
          </div>
